...
#[derive(Debug)]
pub struct ChainAssetsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainAssetsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainAssets processing");
    
    let mut processor = ChainAssetsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainAssetsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainAssetsProcessor::new(false);
